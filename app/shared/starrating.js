...
var StartRating = /** @class */ (function () {
    function StartRating() {
    }
    StartRating.prototype.ngOnChanges = function () {
        this.startWidth = 86 / 5 * this.rating;
    };
    __decorate([
        core_1.Input(),
        __metadata("design:type", Number)
    ], StartRating.prototype, "rating", void 0);
    StartRating = __decorate([
        core_1.Component({
...
exports.StartRating = StartRating;
